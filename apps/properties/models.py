...
class Property(TimeStampedUUIDModel):
    ...
    country = CountryField(verbose_name=_("Country"), default="ID", blank_label="(select country)")
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Nairobi")
    postcode = models.CharField(verbose_name=_("Postal Code"), max_length=100, default="140")
    ...
    tax = models.DecimalField(verbose_name=_("Tax"), max_digits=6, decimal_places=2, default=0.15, help_text="15% prperty tax charged")
    ...
    def final_property_price(self):
        tax_precentage = self.tax
        property_price = self.price
        tax_amount = round(tax_precentage * property_price, 2)
